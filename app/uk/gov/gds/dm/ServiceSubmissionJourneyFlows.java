...
public class ServiceSubmissionJourneyFlows {
    ...
    private final static List<Long> saasFlow = Arrays.asList(2l, 4l, 5l, 6l, 7l, 8l, 9l, 10l, 11l, 12l, 13l, 14l, 15l, 16l, 17l, 18l, 19l, 20l, 21l, 22l, 23l, 24l, 25l, 26l, 27l, 28l, 29l, 30l, 31l, 32l, 33l, 34l, 35l, 36l, 38l, 39l, 40l);
    ...
    private final static List<String> optionalQuestions = Arrays.asList("p8q7", "p16q1", "p17q2", "p20q1", "p21q1");
    ...
    public static List<String> getOptionalQuestions() {
